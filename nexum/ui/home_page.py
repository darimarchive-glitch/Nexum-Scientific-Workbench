...
from nexum.catalog import counts,VERSION
...
class HomePage(Gtk.ScrolledWindow):
    def __init__(self,window):
        ...
        cards=[
            ...
            (f"{c['experiments']} bancadas + {c['analyses']} análises",'Estado calculado','Experimentos evoluem a partir das equações; a animação não inventa química.'),
        ]
