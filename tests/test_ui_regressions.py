...
class UIRegressionTests(unittest.TestCase):
    def test_calculator_workspace_expands_instead_of_collapsing(self):
        src=(ROOT/'nexum/ui/calculators_page.py').read_text(encoding="utf-8")
    ...
    def test_glarea_requests_real_depth_buffer(self):
        src=(ROOT/'nexum/ui/gl_viewer.py').read_text(encoding="utf-8")
    ...
    def test_experiments_have_persistent_selector(self):
        src=(ROOT/'nexum/ui/experiments_page.py').read_text(encoding="utf-8")
